...
return {
    misc = {
        dictionary = {
            ...
            aij_enable_moons = "启用MOD附加天体牌",
            k_aij_guess_the_jest = "笑语猜谜",
            aij_alter_trypophobia = "是否和谐“密集恐惧症”",
    ...
    descriptions = {
        ...
        Joker = {
            ...
            j_aij_negative_space = {
                ...
                text = {
                    ...
                    "{C:inactive}(当前为{C:dark_edition}+#2#{C:inactive}手牌上限){}",
                    "{C:inactive}(上限为{C:dark_edition}+#3#{C:inactive}手牌上限){}"
                }
            },
            j_aij_infinite_jest = {
                name = "无限玩笑",
            ...
            j_aij_null_joker = {
                name = "空值小丑",
                text = {
                    "将所有{C:green}几率{}设为{C:attention}0{}"
                },
            },
            j_aij_magick_joker = {
                name = "魔法小丑",
            ...
            j_aij_teeny_joker = {
                name = "微小丑",
                text = {
                    "如果打出的牌中只含{C:attention}2{}",
                    "则{C:chips}+#1#{} 筹码"
                },
            },j_aij_clowns_on_parade = {
                name = "游行小丑",
                text = {
                    "如果打出的牌中包含至少三张{C:attention}2{}",
            ...
            j_aij_jack_of_all_trades = {
                name = "多面手",
                text = {
                    "{C:attention}J{}可视为{C:attention}任意花色{}",
                },
            },
            j_aij_jumbo_joker = {
                name = "巨型小丑",
            ...
            j_aij_fou_du_roi = {
                name = "宫廷弄臣",
                text = {
                    "若打出的牌包含一张{C:attention}K{}或{C:attention}Q{}",
            ...
            j_aij_corpse_paint = {
                ...
                text = {
                    ...
                    "使手牌上限{C:dark_edition}+#3#",
                    "{C:inactive}（当前为{C:dark_edition}+#4#{C:inactive} 手牌上限）"
                }
            },
            j_aij_toothy_joker = {
                name = "龅牙小丑",
            ...
            j_aij_banana_man = {
                ...
                text = {
                    ...
                    "每张{C:attention}小丑牌{}有{C:green}#1#/#2#{}几率摧毁"
                }
            },
            ...
            j_aij_mahoney = {
                name = "马奥尼",
                text = {
                    "跳过{C:attention}盲注{}时有{C:green}#1#/#2#{}几率",
                    "生成{C:attention}优惠券{}标签",
                }
            },
            ...
            j_aij_bingo_card = {
                ...
                text = {
                    "计分的{C:attention}幸运牌{}",
                    "有{C:green}#1#/#2#{}几率获得{X:mult,C:white}X#4#{}倍率",
                    "有{C:green}#1#/#3#{}几率重新触发"
                }
            },
            j_aij_fish_fingers = {
                name = "炸鱼手指",
            ...
            j_aij_sanguine_joker = {
                name = "乐观小丑",
                text = {
                    "计分的{C:hearts}红桃{}有{C:green}#1#/#2#{}几率",
                    "生成随机{C:attention}标签{}"
                }
            },
            j_aij_choleric_joker = {
                name = "暴躁小丑",
                text = {
                    "计分的{C:hearts}方片{}有{C:green}#1#/#2#{}几率",
                    "生成随机{C:tarot}塔罗牌{}",
                    "{C:inactive}(必须有空间){}"
                }
            },
            j_aij_phlegmatic_joker = {
                name = "冷漠小丑",
                text = {
                    "计分的{C:hearts}梅花{}有{C:green}#1#/#2#{}几率",
            ...
            j_aij_melancholic_joker = {
                name = "忧郁小丑",
                text = {
                    "计分的{C:hearts}黑桃{}有{C:green}#1#/#2#{}几率",
                    "生成随机{C:spectral}幻灵牌{}",
                    "{C:inactive}(必须有空间){}"
                }
            },
            ...
            j_aij_bluet = {
                ...
                text = {
                    ...
                    "一张{C:dark_edition}负片{}版本的{C:spectral}幻灵牌{}"
                },
                unlock = {
                    "?????"
                }
            ...
            j_aij_dongtong = {
                name = "东通",
                text = {
                    "{C:attention}翻倍{}大多数{C:attention}小丑牌{}的效果",
                },
                unlock = { "?????" }
            },
            j_aij_naiteh = {
                ...
                text = {
                    "击败{C:attention}Boss盲注{}时",
                    "手牌上限{C:dark_edition}+#2#",
                    "{C:inactive}（当前为{C:dark_edition}+#1#{C:inactive} 手牌上限）"
                },
                unlock = { "?????" }
            },
            j_aij_talhak = {
                ...
                text = {
                    "击败{C:attention}Boss盲注{}时",
                    "可选择生成一张{C:attention}任意{} {C:spectral}幻灵牌{}",
                    "{C:inactive}（必须有空位）"
                },
                unlock = { "?????" }
            },
        ...
        Other = {
            ...
            palindrome = {
                name = "回文数",
                text = {
                    "一类无论是从前或是从后读都{C:attention}完全相同{}的数",
